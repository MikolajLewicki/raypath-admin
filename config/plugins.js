module.exports = ({env}) => ({
  'strapi-plugin-sso': {
    enabled: true,
    config: {
      OIDC_REDIRECT_URI: "https://healing-sunshine-c3087bad90.strapiapp.com/admin/strapi-plugin-sso/oidc/callback",
      ...
      OIDC_USER_INFO_ENDPOINT: "https://demo251-pl.yourtechnicaldomain.com/panel/action/authorize/access_token",
